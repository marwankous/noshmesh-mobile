...
import 'package:noshmesh/core/network/offline_sync_service.dart';
import 'package:hive/hive.dart';

/// Provider for connectivity service — delegates to the canonical singleton.
final offlineConnectivityProvider = Provider<Connectivity>((ref) {
...
final offlineSyncServiceProvider = Provider<OfflineSyncService>((ref) {
  ...
  return boxAsync.when(
    data: (box) {
      final connectivity = ref.watch(offlineConnectivityProvider);
