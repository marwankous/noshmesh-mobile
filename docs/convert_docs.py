...
site_title = config.get('title', 'Clypify')
site_description = config.get('description', 'Documentation for Clypify')
...
def convert_markdown_to_html(markdown_file, output_file):
    ...
    current_link = f'/clypify/{output_filename}'
...
def process_index_html():
    ...
    soup = BeautifulSoup(page_content, 'html.parser')
    for anchor in soup.select('a[href="/clypify/index.html"]'):
        anchor['class'] = anchor.get('class', []) + ['active']
